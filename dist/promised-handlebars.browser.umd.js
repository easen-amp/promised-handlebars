(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["promisedHandlebars"] = factory();
	else
		root["promisedHandlebars"] = factory();
})(window, function() {
...
/* WEBPACK VAR INJECTION */(function(module, global) {/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es7.symbol.async-iterator */ "./node_modules/core-js/modules/es7.symbol.async-iterator.js");
...
var createMarkers = __webpack_require__(/*! ./lib/markers */ "./lib/markers.js");

var utils = __webpack_require__(/*! ./lib/utils */ "./lib/utils.js"); // Basic utility functions
...
function promisedHandlebars(Handlebars, options) {
  options = options || {};
  options.placeholder = options.placeholder || "\x01";
  ...
  var markers = null; // Wrap `registerHelper` with a custom function

  engine.registerHelper = wrap(engine.registerHelper, function registerHelperWrapper(oldRegisterHelper, args) {
    if (typeof args[0] === 'string' && typeof args[1] === 'function') {
      var name = args[0];
      var helper = args[1]; // Called like "registerHelper(name, helper)"
  ...
  engine.registerHelper(engine.helpers); // Wrap the `compile` function, so that it wraps the compiled-template
  // with `prepareAndResolveMarkers`

  engine.compile = wrap(engine.compile, function compileWrapper(oldCompile, args) {
    var fn = oldCompile.apply(engine, args); // Wrap the compiled function
  ...
  function helperWrapper(fn, args) {
    ...
    var hash = options.hash; // "fn" and "inverse" return strings. They must be able to handle promises
    // just as the compiled template and partials

    options.fn = options.fn && wrap(options.fn, prepareAndResolveMarkers);
    options.inverse = options.inverse && wrap(options.inverse, prepareAndResolveMarkers); // If there are any promises in the helper args or in the hash,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var core_js_modules_es6_array_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es6.array.iterator */ "./node_modules/core-js/modules/es6.array.iterator.js");
...
var isPromiseAlike = __webpack_require__(/*! ./utils */ "./lib/utils.js").isPromiseAlike;

var createReplaceP = __webpack_require__(/*! ./replaceP */ "./lib/replaceP.js");
/**
...
module.exports = function createMarkersClass(Promise) {
  ...
  function Markers(engine, prefix) {
    ...
    this.promiseStore = [];
    this.engine = engine;
    this.prefix = prefix; // one line from substack's quotemeta-package
  ...
  Markers.prototype.asMarker = function asMarker(promise) {
    ...
    var placeholder = this.prefix + this.promiseStore.length + '>'; // Create a new promise, don't modify the input
  ...
  Markers.prototype.resolve = function resolve(input) {
    ...
    return Promise.resolve(input).then(function (output) {
      ...
      return Promise.all(self.promiseStore).then(function (promiseResults) {
        /**
...
module.exports = function createReplaceP(Promise) {
  ...
  return function replaceP(string, regex, replacer) {
    ...
    if (typeof replacer === 'function') {
      var parts = [];
      var lastIndex = 0; // Use "replace" just to iterate all matches conveniently
      ...
      string.replace(regex, function () {
        ...
        var replacementP = deepAPlus(replacer.apply(this, replacerArgs)).then(function (replacement) {
          return String(replacement);
        }); // Next match

        parts.push(replacementP); // Prepare next iteration (switch to first character after match)
...
//# sourceMappingURL=promised-handlebars.browser.umd.map